...
color_green = "#0047AB"
color_light_green = "#D3D3D3"
color_light_pink = "#D92121"
color_pink = "#A8A9AD"
color_white = "white"
...
for row in range(row_count):
    for column in range(column_count):
        ...
        if value in top_symbols:
            button.config(foreground=color_green, background=color_light_green)
        elif value in right_symbols:
            button.config(foreground=color_white, background=color_pink)
        else:
            button.config(foreground=color_white, background=color_light_pink)
